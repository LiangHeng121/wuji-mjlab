...
# REPRODUCTION baseline: the first successful config (simple 114-d obs + offset).
register_mjlab_task(
  task_id="WujiHand_Tracking_Cubesmall_Simple",
  env_cfg=wuji_hand_cubesmall_tracking_env_cfg(num_envs=4096, obs_mode="simple"),
  play_env_cfg=wuji_hand_cubesmall_tracking_env_cfg(play=True, obs_mode="simple"),
